...
class MenuScene extends Phaser.Scene {
  ...
  create() {
    ...
    // Esperar fuente antes de crear textos principales
    ...
    // Controles hint sin esperar la fuente
    this.add.text(W/2, H*0.88, 'W rotar  ·  A D mover  ·  S bajar  ·  ESPACIO caída', {
      fontFamily:'Arial', fontSize:'11px', color:'#333'
    }).setOrigin(0.5);
